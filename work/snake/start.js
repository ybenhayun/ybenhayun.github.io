$(document).ready(function(){
	...
	$("button").mouseover(
		function(){
			...
			if ($(this).attr('id') == "classic") description = "<span class = 'descr'> <br><br><span id = 'name'>CLASSIC:</span> No tricks here. This is the same classic game you played on your Nokia cell phone.<br><br>";
			if ($(this).attr('id') == "bombs") description = "<span class = 'descr'> <br><br><span id = 'name'>BOMBS:</span> This little snake loves fruit, but he seems to leave some nasty things behind as he slithers around...<br>";
			if ($(this).attr('id') == "invis") description = "<span class = 'descr'> <br><br><span id = 'name'>COLORBLIND:</span> This guy loves to eat so much, that sometimes he forgets what he should and shouldn't be putting into his mouth.<br>";
			if ($(this).attr('id') == "walled") description = "<span class = 'descr'> <br><br><span id = 'name'>BOXED IN:</span> I really hope you're not claustrophobic.<br><br><br>";
			if ($(this).attr('id') == "infinity") description = "<span class = 'descr'> <br><br><span id = 'name'>INFINITY:</span> You want a really long snake? Well, here you go.<br><br><br>";
			if ($(this).attr('id') == "mover") description = "<span class = 'descr'> <br><br><span id = 'name'>MOVERS:</span> This snake doesn't mind chasing after the food he wants. And the food isn't going to stop moving anytime soon.<br>";
			if ($(this).attr('id') == "portal") description = "<span class = 'descr'> <br><br><span id = 'name'>PORTAL:</span> This snake is years ahead of its time, and perfectly capable of bending time and space at will!<br><br>";
			if ($(this).attr('id') == "tick") description = "<span class = 'descr'> <br><br><span id = 'name'>TICK TOCK:</span> If you can pick up your fruit quickly, this game will be a breeze. Otherwise...<br><br>";
			if ($(this).attr('id') == "flash") description = "<span class = 'descr'> <br><br><span id = 'name'>FLASH:</span> I hope you have a good memory...<br><br><br><br>";
			if ($(this).attr('id') == "dodge") description = "<span class = 'descr'> <br><br><span id = 'name'>DODGE:</span> If you can dodge a bomb, you can dodge a ball.<br><br><br>";
			if ($(this).attr('id') == "frogger") description = "<span class = 'descr'> <br><br><span id = 'name'>FROGGER:</span> Keep an eye out for traffic. <br><br><br><br>";
			if ($(this).attr('id') == "disoriented") description = "<span class = 'descr'> <br><br><span id = 'name'>GOOD LUCK:</span> Good luck making sense of this one. <br><br><br>";
			if ($(this).attr('id') == "missiles") description = "<span class = 'descr'> <br><br><span id = 'name'>SHOTS FIRED:</span> I hope your snake is wearing some body armor. <br><br><br>";
			if ($(this).attr('id') == "nogod") description = "<span class = 'descr'> <br><br><span id = 'name'>NO SURVIVORS:</span> This is the end... sorry. <br><br><br><br>";
