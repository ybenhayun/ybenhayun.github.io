...
function makeTables() {
    ...
    document.getElementById("corr").style.width = word_length*50 + "px";
    document.getElementById("wrong").style.width = word_length*50 + "px";
    document.getElementById("excl").style.width = word_length*50 + "px";
}
